...
public class CampaignSetUpPrimary : MonoBehaviour
{
    ...
    void DictionaryUpdate(Dictionary<string, string> d, string s, bool notvisit = true, bool gesv = false)
    {
