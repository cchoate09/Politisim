  ...
  return [
    {
      ...
      trustEffect: -1,
      volunteerEffect: 20,
      donorEffects: [{ blocId: leadDonor, relationshipDelta: 3, energyDelta: 8 }],
    ...
    },
    {
      ...
      trustEffect: 1,
      volunteerEffect: 65,
      donorEffects: [{ blocId: 'small_donors', relationshipDelta: 4, energyDelta: 12 }],
      mediaEffects: [
        { channelId: 'digital', intensityDelta: 4 },
    ...
    },
    {
      ...
      mediaEffects: [
        ...
        { channelId: 'local_tv', intensityDelta: 2 }
      ],
      rivalMomentumEffect: -1,
      rivalTrustEffect: -2,
  ...
  return [
    {
      ...
      volunteerEffect: 20,
      donorEffects: [{ blocId: leadDonor, relationshipDelta: 2, energyDelta: 5 }],
      mediaEffects: supportMedia.map((channelId, index) => ({ channelId, intensityDelta: index === 0 ? 3 : 2 })),
      rivalMomentumEffect: -1,
      rivalTrustEffect: -1,
    ...
    },
    {
      ...
      trustEffect: 2,
      volunteerEffect: 15,
      donorEffects: [{ blocId: leadDonor, relationshipDelta: 1, energyDelta: 3 }],
      mediaEffects: [{ channelId: 'local_tv', intensityDelta: 2 }],
...
function buildShakyChoices(
  ...
  return [
    ...
    },
    {
      ...
      trustEffect: 1,
      volunteerEffect: 55,
      donorEffects: [{ blocId: 'small_donors', relationshipDelta: 2, energyDelta: 5 }],
      mediaEffects: [{ channelId: 'digital', intensityDelta: 2 }],
      rivalMomentumEffect: 0,
      rivalTrustEffect: 0,
      rivalBudgetEffect: 0,
    ...
    },
    {
      ...
      mediaEffects: [{ channelId: 'earned_media', intensityDelta: 3 }],
